"use client";
import IProposal, {statusToBadgeColorMap} from "@interfaces/proposal.interface";
            ...
            <div className="mt-8 flex flex-col md:flex-row md:justify-between place-items-start gap-x1 ">
                ...
                <div className={styles.proposal_addons}>
                    <div className={classNames(styles.mobile_controls)}>
                        ...
                        <Button wrapperClassName={styles.mobile_button_wrapper} className={styles.mobile_button}
                                theme="secondary" onClick={() => setVotesListOpened(true)}>
                            Votes
                        </Button>
                    </div>
                    <div className={classNames(styles.backdrop, votingOpened && styles.opened)}>
                        <Card className={classNames(styles.proposal_addon, votingOpened && styles.opened)}>
                            ...
                            <div className="flex flex-col gap-1 ">
                                ...
                                <Button className={styles.button_wrapper} disabled={!isValid} theme="success" block
                                        onClick={handleSubmit((data) => onSubmit(data, 'for'))}>
                                    For
                                </Button>
                                <Button className={styles.button_wrapper} disabled={!isValid} type="submit"
                                        theme="danger" block
                                        onClick={handleSubmit((data) => onSubmit(data, 'against'))}>
                                    Against
                                </Button>
                                <Button className={styles.button_wrapper} disabled={!isValid} type="submit"
                                        theme="tertiary" block
                                        onClick={handleSubmit((data) => onSubmit(data, 'abstain'))}>
                                    Abstain
                                </Button>
                            </div>
                        </Card>
                    ...
                    <div className={classNames(styles.backdrop, votesListOpened && styles.opened)}>
                        <Card
                            ...
                            <Card.Header className="text-center text-2xl">
                                <strong>Votes</strong>
                                <button className={styles.proposal_addon__close}

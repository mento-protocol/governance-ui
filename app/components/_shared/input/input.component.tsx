...
export const Input = ({
    ...
    return (
        <div className={classNames(styles.wrapper, compact && styles.compact, disabled && styles.disabled, className)}>
            {!!label && <label htmlFor={id}>{label}</label>}
            <div className={classNames(styles.input, !!error && styles.error)}>
                <input id={id} placeholder={placeholder} disabled={disabled} type={type} {...form} />
                {addon}
            </div>

...
export const MarkdownEditor = ({ className, style, value, markdownChanged }: MarkdownEditorProps) => {
    ...
    return (
        <div className={classNames(className)} style={style}>
            <div>
                <button
                    className={classNames(styles.editor_button, selectedView === "editor" && styles.active)}
                    onClick={() => setSelectedView("editor")}
                >
                    Editor
                </button>
                <button
                    className={classNames(styles.editor_button, selectedView === "preview" && styles.active)}

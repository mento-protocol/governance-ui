...
export const Textarea = ({ label, id, placeholder, className, form, addon, error, compact }: TextAreaProps) => {
    return (
        <div className={classNames(styles.wrapper, compact && styles.compact, className)}>

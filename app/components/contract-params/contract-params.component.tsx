    ...
    return (
        <div className="grid grid-cols-1 gap-x1 md:grid-cols-7 px-x4 pt-x4">
            <Card className="md:col-span-3">
                <Card.Header>
                    <div className="color-primary text-x4 font-medium  mb-x6">Parameters</div>
                </Card.Header>
                <div className="grid grid-cols-2 gap-x1 justify-between mb-3">
                    <div className="font-semibold">Proposal threshold</div>
                    <div className="text-right">{NumbersService.parseNumericValue(1000000)}</div>
                </div>
                <div className="grid grid-cols-2 gap-x1 justify-between mb-3">
                    <div className="font-semibold">Quorum needed</div>
                    <div className="text-right">{NumbersService.parseNumericValue(180070000, 2)}</div>
                </div>
                <div className="grid grid-cols-2 gap-x1 justify-between mb-3">
            ...
            <Card className="md:col-span-4">
                <Card.Header>
                    <div className="color-primary text-x4 font-medium mb-x6">Mento Core</div>
                </Card.Header>
                <div className="flex gap-x2 justify-between mb-3">
                    <div className="font-semibold">Governor</div>
                    <div className="text-right col-span-2 break-all">1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa</div>
                </div>
                <div className="flex gap-x2 justify-between mb-3">

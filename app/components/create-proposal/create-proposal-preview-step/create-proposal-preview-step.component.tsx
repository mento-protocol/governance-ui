...
export const CreateProposalPreviewStep = () => {
    ...
    return <Wrapper isOpened={form[formStep].isOpened} step={formStep} title="Preview your proposal">
        <div className="ml-x7 mr-x8">
            ...
            <div className="font-size-x6 font-weight-x7 text-center mt-x5 mb-x7 font-medium">{proposal.title}</div>
            ...
            <div>
                <h3 className="flex justify-center font-size-x6 font-weight-x6 font-medium">Details</h3>

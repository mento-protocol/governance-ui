...
export const CreateProposalPreviewStep = () => {
    ...
    return <Wrapper step={formStep} title="Preview your proposal">
        <div className="ml-x7">
            <p className="font-size-x4 line-height-x5">You&apos;ve successfully finished all the steps. Now, take a moment to go over your proposal and then submit it.</p>
            <div className="font-size-x6 line-height-x7 text-center mt-x5 mb-x7 font-medium">{proposal.title}</div>
            <div>
                <h3 className="flex justify-center font-size-x6 line-height-x6 font-medium">Proposal Description</h3>

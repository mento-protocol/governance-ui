...
const Wrapper = ({ children, className, step, title, style }: WrapperProps) => {
    ...
    return (
        <Card block className={classNames(className, "pb-0", styles.wrapper, !isOpened && "opacity-50")} style={style}>
            <Card.Header>
            ...
            <div className={classNames(styles.form_element, isOpened && styles.opened)}>
                ...
                <Card.Footer>
                    <div className="flex full-w justify-start items-center gap-x3">
                        <Button className="min-w-x20" onClick={prev} disabled={!canGoPrev} theme="tertiary">
                            Back
                        </Button>
                        {canGoNext && (
                        ...
                        {!canGoNext && openedForm === CreateProposalFormStepEnum.preview && (

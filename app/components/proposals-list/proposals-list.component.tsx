            ...
            <Card block>
                <div className={classNames(styles.proposals_grid, "text_small")}>
                    <div className={classNames(styles.proposals_grid__row)}>
                        ...
                        <div className={classNames(styles.proposals_grid__row__element, styles.header)}>Status</div>
                        <div className={classNames(styles.proposals_grid__row__element, styles.header)}>
                            Votes in favour
                        </div>
                        <div className={classNames(styles.proposals_grid__row__element, styles.header)}>
                    ...
                    {proposals.map((proposal, index) => (
                        <div key={index} className={classNames(styles.proposals_grid__row)}>
                            ...
                            <div className={classNames(styles.proposals_grid__row__element, styles.last, "mb-3")}>

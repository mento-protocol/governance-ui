...
export type AccessControlRoleMember_Filter = {
  ...
  accesscontrolrole_not_contains_nocase?: InputMaybe<
...
export type RoleAdminChanged_Filter = {
  ...
  previousAdminRole_not_contains_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "getProposals" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {

...
export const useCreateProposalStore = create<CreateProposalStore>((set, get) => ({
    ...
    checkNavigateValidity: () => {
        set({
            canGoNext: get().openedForm !== CreateProposalFormStepEnum.preview && get().form[get().openedForm].isValid,
        ...
        set({
            form: {
                ...
                [CreateProposalFormStepEnum.wallet]: {
                    ...
                    value: {
                        walletAddress: {
                            ...get().form[CreateProposalFormStepEnum.wallet].value.walletAddress,
                            value: value.walletAddress,
                        },
                        balanceVeMENTO: {
                            ...get().form[CreateProposalFormStepEnum.wallet].value.balanceVeMENTO,
        ...
        set({
            form: {
                ...
                [CreateProposalFormStepEnum.execution]: {
                    isOpened: get().form[CreateProposalFormStepEnum.execution].isOpened,

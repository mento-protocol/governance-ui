...
const documents = {
    ...
    "query getMyLocks($address: String) {\n  locks(where: {owner: $address, relocked: false}) {\n    replaces {\n      lockId\n      relock {\n        timestamp\n      }\n    }\n    lockId\n    owner {\n      id\n    }\n    amount\n    time\n    slope\n    cliff\n    lockCreate {\n      id\n      timestamp\n    }\n    relock {\n      id\n      timestamp\n    }\n  }\n}": types.GetMyLocksDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query getMyLocks($address: String) {\n  locks(where: {owner: $address, relocked: false}) {\n    replaces {\n      lockId\n      relock {\n        timestamp\n      }\n    }\n    lockId\n    owner {\n      id\n    }\n    amount\n    time\n    slope\n    cliff\n    lockCreate {\n      id\n      timestamp\n    }\n    relock {\n      id\n      timestamp\n    }\n  }\n}"): (typeof documents)["query getMyLocks($address: String) {\n  locks(where: {owner: $address, relocked: false}) {\n    replaces {\n      lockId\n      relock {\n        timestamp\n      }\n    }\n    lockId\n    owner {\n      id\n    }\n    amount\n    time\n    slope\n    cliff\n    lockCreate {\n      id\n      timestamp\n    }\n    relock {\n      id\n      timestamp\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
